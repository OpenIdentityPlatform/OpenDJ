...
public class JDBCStorageRetryTest extends DirectoryServerTestCase
{
   ...
   * opens and registers the entry containers of every base DN in one write, and before OpenDJ issue #896 a
   * replay of it failed with ERR_ENTRY_CONTAINER_ALREADY_REGISTERED, masking the failure that caused the replay.
   */
  @Test
