...
public class ReplicationServerTest extends ReplicationTestCase
{
  ...
  public void replicationServerConnected() throws Exception
  {
    ...
    try
    {
         ...
         broker1 = openReplicationSession(TEST_ROOT_DN, brokerIds[0], 100, changelogPorts[0], 5000);
         broker2 = openReplicationSession(TEST_ROOT_DN, brokerIds[1], 100, changelogPorts[1], 5000);
