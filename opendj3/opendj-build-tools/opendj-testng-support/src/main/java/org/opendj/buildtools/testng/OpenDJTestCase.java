...
public abstract class OpenDJTestCase
{
   ...
   */
  private final IdentityHashMap<Object[], Object> successfulTestParams =
   ...
   * failures.
   */
  private final IdentityHashMap<Object[], Object> failedTestParams =
    new IdentityHashMap<Object[], Object>();
  ...
  public void nullMemberVariablesAfterTest()
  {
        ...
        && !OpenDJTestCase.class.equals(cls))
    {
      ...
      for (final Field field : fields)
      {
        ...
        // it out so that the garbage collector can reclaim it and everything
        // it references.
