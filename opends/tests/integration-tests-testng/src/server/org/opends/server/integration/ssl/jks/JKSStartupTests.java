...
*/
  ...
  public void testJKSStartup1(String integration_test_home, String dsee_home, String logDir) throws Exception
  {
    ...
    exec_cmd = integration_test_home + "/ssl/jks/generate_server_cert.sh";
  ...
  public void testJKSStartup2(String hostname, String port, String bindDN, String bindPW, String integration_test_home, String logDir) throws Exception
  {
    ...
    String datafile = integration_test_home + "/ssl/jks/data/startup/enable_key_mgr_provider.ldif";
  ...
  @Parameters({ "hostname", "port", "bindDN", "bindPW", "integration_test_home", "logDir" })
  @Test(alwaysRun=true, dependsOnMethods = { "org.opends.server.integration.ssl.jks.JKSStartupTests.testJKSStartup2" })
  public void testJKSStartup3_prep(String hostname, String port, String bindDN, String bindPW, String integration_test_home, String logDir) throws Exception
  {
    ...
    String datafile = integration_test_home + "/ssl/jks/data/startup/deleteTrustMgr.ldif";
    String jks_mod_args[] = {"-h", hostname, "-p", port, "-D", bindDN, "-w", bindPW, "-f", datafile};
  ...
  @Parameters({ "hostname", "port", "bindDN", "bindPW", "integration_test_home", "logDir" })
  @Test(alwaysRun=true, dependsOnMethods = { "org.opends.server.integration.ssl.jks.JKSStartupTests.testJKSStartup3_prep" })
  public void testJKSStartup3(String hostname, String port, String bindDN, String bindPW, String integration_test_home, String logDir) throws Exception
  {
    ...
    String datafile = integration_test_home + "/ssl/jks/data/startup/enable_trust_mgr_provider.ldif";
  ...
  @Parameters({ "hostname", "port", "bindDN", "bindPW", "integration_test_home", "logDir" })
  @Test(alwaysRun=true, dependsOnMethods = { "org.opends.server.integration.ssl.jks.JKSStartupTests.testJKSStartup3" })
  public void testJKSStartup4(String hostname, String port, String bindDN, String bindPW, String integration_test_home, String logDir) throws Exception
  {
    ...
    String datafile = integration_test_home + "/ssl/jks/data/startup/enable_ldaps_conn_handler.ldif";
    String jks_add_args[] = {"-a", "-h", hostname, "-p", port, "-D", bindDN, "-w", bindPW, "-f", datafile};
  ...
  @Test(alwaysRun=true, dependsOnMethods = { "org.opends.server.integration.ssl.jks.JKSStartupTests.testJKSStartup4" })
